...
async def killdabot(event):
    ...
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`SmokingBot Telah Dimatikan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting SmokingBot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`SmokingBot Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Lord-Userbot Repo](https://github.com/IrhamFadzillah/Lord-Userbot/blob/Lord-Userbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "❃ **Repo Userbot:** [Lord-Userbot](https://github.com/IrhamFadzillah/Lord-Userbot)\n❃ **Pemilik:** [Irham](t.me/StayWithMe69)"
    )
